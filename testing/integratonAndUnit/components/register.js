...
const Register = (props) => {
    ...
    <form className='flex-column surface'>
        <input data-testid='register-input' id='register-input' ref={emailRef} className='w-30 middle front media-wide' type='email' placeholder={Object.keys(languageData).length > 0 ? languageData.register.emailPlaceholder[language] : ''} />
        <input data-testid='password-input' id='password-input' ref={passwordRef} onInput={(e) => setPassword(e.currentTarget.value)} className='w-30 middle front media-wide' type='password' placeholder={Object.keys(languageData).length > 0 ? languageData.register.passwordPlaceholder[language] : ''} />
        <ul className='middle front bullet' dir={Object.keys(languageData).length > 0 ? languageData.direction[language] : ''}>
            ...
            <li>
                ...
                <input data-testid='pass-val-long' id='checkBoxBlock' type='checkbox' disabled checked={passwordValidator.long ? true : false} style={{margin: '0.2rem auto 0 auto',}}></input>
            </li>
            <li>
                <mark id='pass-val-limit'><strong>{Object.keys(languageData).length > 0 ? languageData.register.passwordRule2[language] : ''}</strong></mark>
                <input data-testid='pass-val-limit' id='checkBoxBlock' type='checkbox' disabled checked={passwordValidator.chacractersLimit ? true : false} style={{margin: '0.2rem auto 0 auto',}}></input>
            </li>
            <li>
                <mark id='pass-val-sten'> <strong>{Object.keys(languageData).length > 0 ? languageData.register.passwordRule3[language] : ''}</strong></mark>
                <input data-testid='pass-val-sten' id='checkBoxBlock' type='checkbox' disabled checked={passwordValidator.startEndNo ? true : false} style={{margin: '0.2rem auto 0 auto',}}></input>
            </li>
        </ul>
        <button data-testid='regsiter-btn' id='regsiter-btn'onAnimationStart={() => {
