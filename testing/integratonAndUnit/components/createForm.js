    ...
    <>
        <form id='request-from' className='plain-surface'>
            <section className='sec-flex'>
                <input data-testid='request-title' id='request-title' ref={titleRef} className='w-30 middle media-wide' type='text' placeholder={Object.keys(languageData).length > 0 ? languageData.create.titlePlaceholder[language] : ''}></input>
                <textarea data-testid='request-desc' id='request-desc' ref={descriptionRef} className='middle' placeholder={Object.keys(languageData).length > 0 ? languageData.create.descPlaceholder[language] : ''} rows='10' cols={windowWidth < 870 ? '40' : '100'}></textarea>
            </section>
            <section className='sec-flex w-center'>
                <label data-testid='pending-demo' id='pending-demo' onClick={() => setStatus('pending')} className="radio-container" htmlFor='pending' >
                ...
                <label data-testid='progress-demo' onClick={() => setStatus('in-progress')} className="radio-container" htmlFor='progress'>
                ...
                <label data-testid='complete-demo' onClick={() => setStatus('completed')} className="radio-container" htmlFor='completed'>
            ...
            <section className='sec-flex w-center'>
                <label data-testid='request-crawler-demo' id='request-crawler-demo' htmlFor='request-crawler'>
            ...
            <section id='request-btn' >
                <button data-testid='request-btn-demo' id='request-btn-demo' onClick={(e) => {
                    e.preventDefault();
